...
if __name__ == "__main__":
    ...
    use_flash_attention = False     # ADDED YK
    ...
    tokenizer = AutoTokenizer.from_pretrained(args.model_name, token=access_token,trust_remote_code=args.trust_remote_code,add_eos_token=args.add_eos_token,add_bos_token=args.add_bos_token,use_fast=True,cache_dir = "/data2/yikyungkim/cache")
    custom_tokens = None
    ...
    model = AutoModelForCausalLM.from_pretrained(args.model_name, token=access_token,quantization_config=bnb_config,trust_remote_code=args.trust_remote_code,torch_dtype=torch_dtype,config=config,use_flash_attention_2=use_flash_attention, **kwargs, cache_dir = "/data2/yikyungkim/cache")
